...
#
# Usage:
#   ./start_vllm_cluster.sh [MODEL] [MODE] [TP_PER_SERVER]
#
# Examples:
#   ./start_vllm_cluster.sh
#   ./start_vllm_cluster.sh "/data2/Qwen3-30B-A3B-Instruct-2507" data 2
#   ./start_vllm_cluster.sh "/data2/Qwen3-30B-A3B-Instruct-2507" tensor 4
#
# Modes:
