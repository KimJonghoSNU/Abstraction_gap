...
REWRITE_CACHE_BASE="/data4/jongho/Search-o1/data/QA_Datasets/bright/stepback_json/slate/qwen3-4b-instruct-2507"
...
# Cache base dirs (optional, will be created if missing)
QE_CACHE_BASE="/data4/jongho/Search-o1/data/QA_Datasets/bright/stepback_json/pre_flat/qwen3-4b-instruct-2507"
REWRITE_CACHE_BASE="/data4/jongho/Search-o1/data/QA_Datasets/bright/stepback_json/mixed/qwen3-4b-instruct-2507"
