...
mkdir -p ../logs
LOG_FILE="../logs/run_baseline2_qe_agent_executor_$(date '+%Y_%m_%d').log"
...
log "Starting run_baseline2_qe_agent_executor.sh script"

# Common params (key value pairs or flags). Run-specific params override these.
COMMON_PARAMS=(
    --suffix baseline22_qe_agent_executor
    ...
    --qe_prompt_name agent_executor_v1
)
