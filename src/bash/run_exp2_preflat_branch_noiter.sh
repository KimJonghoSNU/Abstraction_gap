...
mkdir -p ../logs
LOG_FILE="../logs/run_exp2_preflat_branch_noiter_$(date '+%Y_%m_%d').log"
...
log "Starting run_exp2_preflat_branch_noiter.sh script"
...
REWRITE_CACHE_TAG="exp2_preflat_branch_noiter"

# Common params (key value pairs or flags). Run-specific params override these.
COMMON_PARAMS=(
    --suffix exp2_preflat_branch_noiter
