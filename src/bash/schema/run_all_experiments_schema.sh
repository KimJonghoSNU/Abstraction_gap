...
bash "$SCRIPT_DIR/run_exp3_preflat_all_iter_schema.sh"
bash "$SCRIPT_DIR/run_exp2_preflat_leaf_noiter_schema.sh"
bash "$SCRIPT_DIR/run_exp2_preflat_branch_noiter_schema.sh"
bash "$SCRIPT_DIR/run_exp3_preflat_leaf_iter_schema.sh"
bash "$SCRIPT_DIR/run_exp3_preflat_branch_iter_schema.sh"
bash "$SCRIPT_DIR/run_exp3_preflat_leaf_iter_schema_slate.sh"
