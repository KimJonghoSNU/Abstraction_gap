REWRITE_PROMPT_TEMPLATES = {
    ...
    "gate_rewrite_schema_v1": (
        ...
        "Task:\n"
        "- First, write a 1-2 sentence Plan that states the user's core intent and what kind of evidence would justify the answer.\n"
        "- Use the schema as a structure guide; do not treat it as ground truth.\n"
        "- Use the context summaries only as hints (not ground truth).\n"
        "- Produce 2-5 distinct Possible_Answer_Docs, guided by the schema categories.\n"
        "- Avoid near-duplicates; keep each item short and retrieval-friendly.\n\n"
        "Output JSON only:\n"
        "{\n"
        "  \"Plan\": \"short reasoning\",\n"
        ...
        "Original Query:\n{original_query}\n\n"
        "Previous Rewritten Query:\n{previous_rewrite}\n\n"
        "Abstraction Schema (tree-derived):\n{schema_labels}\n\n"
        "Context Summaries:\n{gate_descs}\n"
    ),
    "stepback_json": (
...
SCHEMA_PROMPT_TEMPLATE = (
    ...
    "Given:\n"
    "- Original query\n"
    "- Branch descriptions retrieved from a corpus tree (query-agnostic summaries)\n\n"
    "Task:\n"
    "- Propose 3-5 abstraction categories that will guide query rewriting.\n"
    "- Categories should be short, retrieval-friendly, and non-overlapping.\n"
    "- Use the branch descriptions as hints, but do not copy them verbatim.\n\n"
    "- Light examples of category *types* (do not copy these labels): "
    "theory, key entity, mathematical model, empirical/analogical evidence.\n\n"
    "Output JSON only:\n"
    "{\n"
    "  \"schema_labels\": [\"...\", \"...\", \"...\"]\n"
    "}\n\n"
